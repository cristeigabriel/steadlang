...
#define vector_add_asg(vec_addr)                                               \
  ((typeof(*vec_addr))(                                                        \
      _vector_add((vector *)vec_addr, sizeof(typeof(**vec_addr)))))
#define vector_insert_asg(vec_addr, pos)                                       \
  ((typeof(*vec_addr))(                                                        \
      _vector_insert((vector *)vec_addr, sizeof(typeof(**vec_addr)), pos)))
...
#define vector_erase(vec, pos, len)                                            \
  (_vector_erase((vector *)vec, sizeof(typeof(*vec)), pos, len))
#define vector_remove(vec, pos)                                                \
  (_vector_remove((vector *)vec, sizeof(typeof(*vec)), pos))
